...
function produce_armbian_kernel_inventory() {
	...
	add_bootable_id "uboot-aml" HANDLER='armbian_uboot_amlogic' TAG='armbian-sbc' UBOOT_TYPE='extlinux' # all meson64, mainline kernel and u-boot, uses extlinux to boot
	...
	add_bootable_id "uboot-rk" HANDLER='armbian_uboot_rockchip' TAG='armbian-sbc' UBOOT_TYPE='extlinux' # rk3588, mainline u-boot, uses extlinux to boot
