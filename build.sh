...
declare -A kernel_data=(
	...
	# Armbian Rockchip vendor kernel. For rk3566, rk3568, rk3588, rk3588s - it reasonably well
	# matches the DT included in https://github.com/edk2-porting/edk2-rk3588 which has support for PXE.
