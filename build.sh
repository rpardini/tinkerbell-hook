...
declare -a kernels=(
	...
	"peg-default-amd64"  # Linuxkit "packet" example; LinuxKit's own kernel; minimal firmware; LinuxKit 1.2.0
	"pegk-default-amd64" # Hook default kernel, minimal firmware; LinuxKit 1.2.0
...
declare -A kernel_data=(
	...
	# for development purposes; testing new LK version and simpler LK configurations, using the default kernels or LinuxKit's own
	...
	["pegk-default-amd64"]="['METHOD']='default' ['ARCH']='x86_64' ['KERNEL_MAJOR']='5' ['KERNEL_MINOR']='10' ['KCONFIG']='generic' ['USE_KERNEL_ID']='hook-default-amd64' ['TEMPLATE']='pegk' ['LINUXKIT_VERSION']='1.2.0' "
	...
	# legacy - matches the DT included in https://github.com/edk2-porting/edk2-rk3588 v0.9.1
	# vendor - hdmi/vop crashes vs edk2 v0.9.1 - mismatched DTB + bsp kernel = pain
	...
	["armbian-rk35xx-legacy"]="['METHOD']='armbian' ['ARCH']='aarch64' ['ARMBIAN_KERNEL_ARTIFACT']='kernel-rk35xx-legacy' "
